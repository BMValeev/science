...
property var locale: Qt.locale()
    ...
    height:parent.height
        Button{       text: "Овал мкм.";height:parent.height/6;width:parent.width;enabled:false;           }
    ...
    height:parent.height
        ...
        animationOptions: ChartView.NoAnimation
        theme: ChartView.ChartThemeDark
        SplineSeries {id:lineSeries2;axisX: axisX1;axisY: axisY1;useOpenGL:true;}
        ValueAxis { id: axisY1;min: -10; max: 10; }
        ValueAxis {id: axisX1;min: -10;max: 10;}
        }
    }
    ...
    onTriggered: {
        ...
        if(dataSource.getVal(3)>80.0){
            ...
            dataSource.update(chatter.series(0),5);
